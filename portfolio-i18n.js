(()=>{
  ...
  const T={
    hero:{
      ...
      copy:['Five real projects are currently in the portfolio. SATHI AI is intentionally still a small FloodSafe Nepal companion prototype today; the broader study, web Q&A and advanced assistant phase is planned for November. I keep the portfolio aligned with what is actually built and being tested now.','पोर्टफोलियोमा अहिले पाँच वास्तविक प्रोजेक्ट छन्। SATHI AI हाल जानाजानी सानो FloodSafe Nepal companion prototype मात्र हो; full study, web Q&A र advanced assistant phase नोभेम्बरबाट सुरु गर्ने योजना छ। पोर्टफोलियोमा अहिले बनेको र test भइरहेको कुरा मात्र देखाइन्छ।'],
    ...
    projects:{
      ...
      sathi:{
        status:['Early prototype · FloodSafe companion only','प्रारम्भिक prototype · FloodSafe companion मात्र'],
        desc:['SATHI AI is currently a limited companion inside the FloodSafe Nepal experience, not yet the full assistant. When the companion is installed or enabled, it is designed to request the permissions it needs and run alongside FloodSafe in the background. The present phase stays focused on FloodSafe-related assistance only. Full study features, broad web question-answering and stronger assistant capabilities are planned for the November development phase, once the required paid services and features are available.','SATHI AI अहिले FloodSafe Nepal भित्रको सीमित companion मात्र हो, full assistant अझै होइन। Companion install वा enable गर्दा आवश्यक permissions माग्ने र FloodSafe सँगै background मा चल्ने गरी design गरिएको छ। अहिलेको phase FloodSafe सम्बन्धित सहायता मात्रमा सीमित छ। Full study features, broad web question-answering र अझ बलियो assistant क्षमता आवश्यक paid services/features उपलब्ध भएपछि नोभेम्बरको development phase बाट सुरु गर्ने योजना छ।'],
        bullets:[
          ['Current scope: FloodSafe Nepal companion only.','हालको scope: FloodSafe Nepal companion मात्र।'],
          ...
          ['Current prototype does not yet provide full study or broad web Q&A capability.','हालको prototype मा full study वा broad web Q&A क्षमता अझै छैन।'],
          ['November phase: start the full study app and stronger assistant work.','नोभेम्बर phase: full study app र stronger assistant work सुरु गर्ने।'],
          ['Advanced capabilities will be added when the required paid services/features are available.','आवश्यक paid services/features उपलब्ध भएपछि advanced capabilities थपिने।']
        ],
  ...
  function ensureSathi(){
    ...
    if(aside&&!q('[data-product="sathi-ai"]',aside)){
      ...
      card.innerHTML='<div class="ticket-head"><h3>SATHI AI</h3><span class="tag">EARLY PROTOTYPE</span></div><p>FloodSafe Nepal companion only for now. Full study and broader assistant work is planned for November.</p><a href="#sathi-ai">View build notes →</a>';
    ...
    if(!q('#sathi-ai')){
      ...
      if(after){
        ...
        article.innerHTML=`<div class="project-side"><div><div class="project-index">05 / FloodSafe companion prototype</div><h3>SATHI AI</h3><div class="project-status"><span class="dot"></span> Early prototype</div></div><div class="side-links"><a href="#contact">Project contact ↗</a></div></div><div class="project-main"><div class="project-copy"><p></p><div class="bullets"><div class="bullet"><i>01</i><span></span></div><div class="bullet"><i>02</i><span></span></div><div class="bullet"><i>03</i><span></span></div><div class="bullet"><i>04</i><span></span></div><div class="bullet"><i>05</i><span></span></div><div class="bullet"><i>06</i><span></span></div></div></div><div class="sathi-preview"><div class="sp-head"><span>SATHI / FLOODSAFE COMPANION</span><span class="sp-status"><span class="sp-pulse"></span>PROTOTYPE</span></div><div class="sp-lines"><div class="sp-line"><b class="sp-key">scope</b><span class="sp-value">FloodSafe companion only</span></div><div class="sp-line"><b class="sp-key">permission</b><span class="sp-value">user-granted setup</span></div><div class="sp-line"><b class="sp-key">background</b><span class="sp-value">runs alongside FloodSafe</span></div><div class="sp-line"><b class="sp-key">study</b><span class="sp-value">planned from November</span></div><div class="sp-line"><b class="sp-key">web-q&a</b><span class="sp-value">planned from November</span></div><div class="sp-line"><b class="sp-key">advanced</b><span class="sp-value">later paid-service phase</span></div><div class="sp-line"><b class="sp-key">status</b><span class="sp-value">limited prototype</span></div></div></div></div>`;
