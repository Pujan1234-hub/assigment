const CACHE='floodsafe-nepal-v25-shell-8';
const SHELL=['./','./index.html','./map.html','./alerts.html','./people.html','./weather.html','./news.html','./sources.html','./shell.css','./live-core.css','./live-core.js','./app.js','./ui-cleanup.js','./national-news.js','./manifest.webmanifest','../v24/icon.svg'];
...
self.addEventListener('fetch',e=>{
 ...
 if(/\/data\/.*\.json$/.test(u.pathname)){
   e.respondWith(fetch(e.request,{cache:'no-store'}));
   return;
 }
 const page=/\.html$|\/v25\/?$/.test(u.pathname);
 if(page){
