...
# zoomBy may have been rewritten by older native patches; replace the complete zoomTo expression.
...
if n==0:
    # Fallback: marker is still useful because MapLibre minZoom itself prevents the broken world-scale state.
