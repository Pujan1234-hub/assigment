...
const TIPS=[
  [
    "कागजात सुरक्षित राख्नुहोस्",
    "नागरिकता र अरू जरूरी कागजात पानी नछिर्ने झोला वा बट्टामा राख्नुहोस्। त्यसलाई घरमा पानी पस्दा पनि नभिज्ने अग्लो, सुरक्षित ठाउँमा राख्नुहोस्।",
    "Protect documents",
    "Keep important documents waterproof and above potential flood levels.",
    0
  ],
  [
    "सुरक्षित ठाउँमा जाने बाटो चिन्नुहोस्",
    "बाढी आएमा कहाँ जाने र कुन बाटो सुरक्षित हुन्छ, पहिल्यै बुझ्नुहोस्। गाडी नचले पैदल जान मिल्ने बाटो पनि थाहा पाउनुहोस्।",
    "Plan an exit",
    "Identify safe evacuation routes, including routes on foot.",
    0
  ],
  [
    "छुट्टिएमा कहाँ भेट्ने?",
    "बाढीका बेला परिवारका सदस्य छुट्टिएमा कहाँ भेट्ने र कसरी सम्पर्क गर्ने, पहिल्यै सल्लाह गर्नुहोस्।",
    "Plan to reconnect",
    "Agree how your family will contact and reunite after separation.",
    0
  ],
  [
    "घरपालुवा जनावरको पनि तयारी गर्नुहोस्",
    "बाढी आउनुअघि गाईभैंसी र अरू घरपालुवा जनावरलाई कहाँ र कसरी सुरक्षित सार्ने, योजना बनाउनुहोस्।",
    "Include animals",
    "Plan safe evacuation for pets and livestock in advance.",
    0
  ],
  [
    "आफ्नो ठाउँको जोखिम बुझ्नुहोस्",
    "आफ्नो टोलमा पहिले बाढी कहाँसम्म आएको थियो र अहिले कहाँ जोखिम छ, स्थानीय निकाय र छिमेकीसँग बुझ्नुहोस्।",
    "Know local risks",
    "Ask local authorities and neighbours about flood risk.",
    0
  ],
  [
    "विद्यालय र काम गर्ने ठाउँबाट कहाँ जाने?",
    "बाढी आउँदा विद्यालय वा काम गर्ने ठाउँमा हुनुहुन्छ भने त्यहाँबाट कुन सुरक्षित ठाउँमा जाने, पहिल्यै योजना बनाउनुहोस्।",
    "Plan beyond home",
    "Plan safe evacuation from school and work too.",
    0
  ],
  [
    "टर्च र ब्याट्री राख्नुहोस्",
    "आपत् पर्दा बोक्ने झोलामा टर्च र थप ब्याट्री राख्नुहोस्। बत्ती गएमा यी सामान काम लाग्छन्।",
    "Pack a torch",
    "Include a torch and spare batteries in your emergency kit.",
    1
  ],
  [
    "चार्जर तयार राख्नुहोस्",
    "फोन र आफूलाई आवश्यक पर्ने उपकरणका चार्जर आपत् पर्दा साथमा लैजान मिल्ने गरी राख्नुहोस्।",
    "Charging essentials",
    "Keep phone and essential-device chargers ready.",
    1
  ],
  [
    "नियमित औषधि नछुटाउनुहोस्",
    "आफूले नियमित खाने औषधि, डाक्टरले औषधि लेखिदिएको पुर्जा र जरूरी स्वास्थ्य कागजात साथमा लैजान तयार राख्नुहोस्।",
    "Medication essentials",
    "Keep essential medication, medical information and prescriptions ready.",
    1
  ],
  [
    "खाना र पानी तयार राख्नुहोस्",
    "आपत् पर्दाका लागि छिट्टै नबिग्रने, नपकाई खान मिल्ने खानेकुरा र बोतलमा पिउने पानी राख्नुहोस्।",
    "Food and water",
    "Store bottled water and long-lasting food needing no cooking.",
    1
  ],
  [
    "परिवारका सबैको आवश्यकता सम्झनुहोस्",
    "आपत्कालीन सामान जुटाउँदा साना बच्चा र अपाङ्गता भएका सदस्यलाई चाहिने सामान पनि राख्नुहोस्। घरपालुवा जनावरका लागि चाहिने सामान नबिर्सनुहोस्।",
    "Include everyone",
    "Adapt your emergency kit for babies, disabilities and pets.",
    1
  ],
  [
    "सामान बिस्तारै जुटाउनुहोस्",
    "सबै सामान एकैपटक किन्नुपर्दैन। घरमै भएका उपयोगी सामान छुट्याउनुहोस् र आपत् पर्दा बोक्ने झोला बिस्तारै तयार गर्नुहोस्।",
    "Build gradually",
    "Build your emergency kit gradually using useful items already at home.",
    1
  ],
  [
    "बाढीको पानी तर्न नखोज्नुहोस्",
    "बाढीको पानीमा हिँडेर, पौडिएर वा गाडी चलाएर पार गर्ने प्रयास नगर्नुहोस्।",
    "Avoid floodwater",
    "Do not attempt to walk, swim or drive through floodwater.",
    2
  ],
  [
    "बन्द गरिएको सडकबाट नजानुहोस्",
    "बाढीका कारण सडकमा रोक लगाइएको छ भने छेकेर राखिएका सामान पन्छाएर वा छलेर नजानुहोस्। पानीमुनिको सडक भत्किएको हुन सक्छ।",
    "Respect road barriers",
    "Never bypass flood-road barriers; the road underneath may have collapsed.",
    3
  ],
  [
    "पानीमुनिको बाटो सुरक्षित नहुन सक्छ",
    "बाढीको पानीले खुला ढल, फोहोर र भत्किएको बाटो छोपेको हुन सक्छ। बाहिरबाट नदेखिँदैमा बाटो सुरक्षित हुन्छ भन्ने हुँदैन।",
    "Hidden hazards",
    "Floodwater can conceal open drains, debris and damaged roads.",
    4
  ],
  [
    "सम्पर्क नम्बर कागजमा पनि लेख्नुहोस्",
    "आपत् पर्दा सम्पर्क गर्ने व्यक्तिका नम्बर फोनमा मात्र नराख्नुहोस्। कागजमा पनि लेखेर साथमा बोक्ने झोलामा राख्नुहोस्।",
