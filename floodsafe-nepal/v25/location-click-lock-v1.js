...
if(!document.querySelector('script[data-fs-location-runtime]')){const s=document.createElement('script');s.src='./location-runtime-v3.js?v=1';s.defer=true;s.dataset.fsLocationRuntime='1';document.head.appendChild(s)}
})();
