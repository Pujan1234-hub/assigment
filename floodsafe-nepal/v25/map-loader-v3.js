...
if(!window.__fsSmoothMapLoadingV5){
  window.__fsSmoothMapLoadingV5=true;
  import('./map-smooth-v3.js?v=3').then(()=>{
    window.__fsSmoothMapLoaded=true;
    return import('./hydro-smooth-v2.js?v=4');
  }).then(()=>{
    window.__fsHydroSmoothLoaded=true;
  }).catch((err)=>{
    window.__fsSmoothMapLoadingV5=false;
