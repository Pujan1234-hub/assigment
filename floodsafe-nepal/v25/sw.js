const CACHE='floodsafe-nepal-v25-shell-3';
const SHELL=['./','./index.html','./alerts.html','./people.html','./weather.html','./news.html','./sources.html','./shell.css','./app.js','./ui-cleanup.js','./manifest.webmanifest','../v24/icon.svg'];
